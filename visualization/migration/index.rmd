...
```{r plot_2_region, include=FALSE}
ggplot(data = df,
       aes(axis1 = region_mex_named,
           axis2 = sector_cross,
           axis4 = census_region_us)) +
  scale_x_discrete(limits = c("Origin in\nMexico",
                              "Border Patrol\nSector of Crossing",
                              "Census Region\nDestination"),
                   expand = c(.1, .05)) +
...
ggsave("census_region.png", width = 10, height = 8)

```

```{r plot_3_div, include=FALSE}
ggplot(data = df,
       aes(axis1 = region_mex_named,
           axis2 = sector_cross,
           axis4 = census_div_us)) +
...
ggsave("census_div.png", width = 10, height = 8)
